...
const promise = loadStripe('pk_test_51Lvf0LSGYzsFHKXzsH93fpqX1XXOEPMfaRKnxJhINsuArLziLEc8HCQV0XilXspLQEyI74QmS2ijR6Ea1djdCqWO00A3vURpCJ');
  ...
  return (
    <div>
      ...
      <form id='payment-form' onSubmit={handleSubmit}>
        ...
        {/* Show any error that happens when processing payments */}
        {error && (
